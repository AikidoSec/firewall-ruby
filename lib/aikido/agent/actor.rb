...
module Aikido::Agent
  ...
  #     mapped via {Aikido::Agent::Config#user_attribute_mappings} to build an
  #     Actor object.
  #   @return Aikido::Agent::Actor
  #
  # @overload Actor(data)
  ...
  class Actor
    ...
    def initialize(
      id:,
      name: nil,
      ip: Aikido::Agent.current_context&.request&.ip,
    ...
    #   value.
    # @return [void]
    def update(seen_at: Time.now.utc, ip: Aikido::Agent.current_context&.request&.ip)
