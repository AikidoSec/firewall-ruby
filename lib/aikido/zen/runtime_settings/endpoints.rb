...
module Aikido::Zen
  ...
  # settings, that will return the singleton {Route::ProtectionSettings.none}.
  #
  # @example
  ...
  class RuntimeSettings::Endpoints
    ...
    def self.from_json(data)
      data = Array(data).map { |item|
        ...
        settings = Route::ProtectionSettings.from_json(item)
        [route, settings]
      }.to_h
    ...
    def initialize(data = {})
      @endpoints = data
      @endpoints.default = Route::ProtectionSettings.none
    end
