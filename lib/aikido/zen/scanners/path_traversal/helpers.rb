    ...
    module PathTraversal
      ...
      module Helpers
        ...
        def self.starts_with_unsafe_path(filepath, user_input)
          ...
          normalized_path = File.expand_path__original_internal_usage(filepath).downcase
          normalized_user_input = File.expand_path__original_internal_usage(user_input).downcase
