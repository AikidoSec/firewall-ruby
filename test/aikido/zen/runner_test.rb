...
class Aikido::Zen::RunnerTest < ActiveSupport::TestCase
  # Make it easier to test
  Aikido::Zen::Runner.attr_reader :timer_tasks, :delayed_tasks
  ...
  setup do
    ...
    @runner = Aikido::Zen::Runner.new(api_client: @api_client)
