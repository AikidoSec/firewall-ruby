...
class Aikido::Zen::Sinks::NetHTTPTest < ActiveSupport::TestCase
  ...
  class ConnectionBlockingTest < ActiveSupport::TestCase
    ...
    test "blockNewOutgoingRequests can be reconfigured" do
    ...
    test "domains can be reconfigured" do
      configure_domains(block_new: false, domains: [])
    ...
    test "blockNewOutgoingRequests and domains can be reconfigured" do
      configure_domains(block_new: true, domains: [])
