...
class Aikido::Agent::Request::HeuristicRouterTest < ActiveSupport::TestCase
  setup do
  ...
  def assert_parameterizes(path, into:)
    ...
    expected = Aikido::Agent::Route.new(verb: "GET", path: into)
  ...
  class SecretMatcherTest < ActiveSupport::TestCase
    SecretMatcher = Aikido::Agent::Request::HeuristicRouter::SecretMatcher
