...
class Aikido::Agent::Request::RailsRouterTest < ActiveSupport::TestCase
  setup do
    @routes = ActionDispatch::Routing::RouteSet.new
    @router = Aikido::Agent::Request::RailsRouter.new(@routes)
  end
  ...
  def build_request(path, env = {})
    ...
    Aikido::Agent::Request.new(req, framework: "rails", router: Object.new)
  end
