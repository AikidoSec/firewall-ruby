...
class Aikido::Agent::CappedCollectionsTest < ActiveSupport::TestCase
  ...
  class MapTest < ActiveSupport::TestCase
    test "an empty map" do
      map = Aikido::Agent::CappedMap.new(3)
